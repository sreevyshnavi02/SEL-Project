...
<body>
    ...
    <?php 
        ...
        echo "</div>";
    ?>
    <div class="course_regn">
    <!-- Display compulsory courses -->
    <h2 style='text-align:center; padding: 1rem;'>Compulsory Courses</h2>
    <table class="courses">
        <tr>
            <th>Course Code</th>
            <th>Course Name</th>
    ...
    if($oec != 0){
    ?>
        <h2 style='text-align:center; padding: 1rem;'>Open Elective Course</h2>
        <table class="courses">
            <tr>
                <th>Course Code</th>
                <th>Course Name</th>
    ...
    if($hm_course != 0){
    ?>
        <h2 style='text-align:center; padding: 1rem;'>Honor/Minor Course</h2>
        <table class="courses">
            <tr>
                <th>Course Code</th>
                <th>Course Name</th>
    ...
    <?php
    $_SESSION['session'] = '23A';
    $hm_course = fetch_uncleared_mandatory($conn, $stud_data['regno'], $_SESSION['session']);
    if($hm_course != 0){
    ?>
        <h2 style='text-align:center; padding: 1rem;'>Mandatory 0 credit Course(uncleared)</h2>
        <table class="courses">
            <tr>
                <th>Course Code</th>
                <th>Course Name</th>
    ...
    ?>
        ...
        <button class="small_btn" onclick="get_confirmation()">Submit</button>
