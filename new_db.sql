...
INSERT INTO `U_PRGM_ELECTIVE_COURSE` (
  `PRGM_ID`,
  `COURSE_CODE`,
  `SEM`,
...
--
ALTER TABLE `ACADEMIC_CALENDAR` ADD PRIMARY KEY (`SEM`);

--
-- Indexes for table `u_administration`
--
ALTER TABLE `U_ADMINISTRATION` ADD KEY `FK_FID` (`F_ID`);

--
-- Indexes for table `u_course`
--
ALTER TABLE `U_COURSE` ADD PRIMARY KEY (`COURSE_CODE`), ADD KEY `DEPT_ID` (`DEPT_ID`);

--
-- Indexes for table `u_course_regn`
--
ALTER TABLE `U_COURSE_REGN` ADD PRIMARY KEY (`REGNO`, `COURSE_CODE`, `SEM`, `SESSION`), ADD KEY `FK_COURSE_CODE3` (`COURSE_CODE`), ADD KEY `FK_FACULTY_ID` (`FACULTY_ID`);

--
-- Indexes for table `u_dept`
--
ALTER TABLE `U_DEPT` ADD PRIMARY KEY (`DEPT_ID`);

--
-- Indexes for table `u_exam_regn`
--
ALTER TABLE `U_EXAM_REGN` ADD KEY `FK_REGNO5` (`REGNO`);

--
-- Indexes for table `u_external_marks`
--
ALTER TABLE `U_EXTERNAL_MARKS` ADD PRIMARY KEY (`REGNO`, `COURSE_CODE`, `SESSION`), ADD KEY `FK_COURSE_CODE1` (`COURSE_CODE`);

--
-- Indexes for table `u_faculty`
--
ALTER TABLE `U_FACULTY` ADD PRIMARY KEY (`FACULTY_ID`), ADD KEY `FK_DEPT_ID2` (`DEPT_ID`);
...
--
ALTER TABLE `U_GPA_CGPA` ADD KEY `FK_REGNO2` (`REGNO`);

--
-- Indexes for table `u_hm_allotment`
--
ALTER TABLE `U_HM_ALLOTMENT` ADD PRIMARY KEY (`REGNO`, `ALLOTED_PRGM`), ADD KEY `ALLOTED_PRGM` (`ALLOTED_PRGM`);

--
-- Indexes for table `u_hm_preregistration`
--
ALTER TABLE `U_HM_PREREGISTRATION` ADD KEY `FK_REGNO4` (`REGNO`), ADD KEY `FK_PRGM_ID_HM1` (`OPT1_PRGM_ID`), ADD KEY `FK_PRGM_ID_HM2` (`OPT2_PRGM_ID`), ADD KEY `FK_PRGM_ID_HM3` (`OPT3_PRGM_ID`);

--
-- Indexes for table `u_oec_allotment`
--
ALTER TABLE `U_OEC_ALLOTMENT` ADD PRIMARY KEY (`REGNO`, `COURSE_CODE`, `SESSION`), ADD KEY `COURSE_CODE` (`COURSE_CODE`);

--
-- Indexes for table `u_prgm`
--
ALTER TABLE `U_PRGM` ADD PRIMARY KEY (`PRGM_ID`), ADD KEY `FK_DEPT_ID` (`DEPT_ID`);

--
-- Indexes for table `u_prgm_comp_course`
--
ALTER TABLE `U_PRGM_COMP_COURSE` ADD KEY `FK_PRGM_ID` (`PRGM_ID`), ADD KEY `FK_COURSE_CODE` (`COURSE_CODE`);

--
-- Indexes for table `u_prgm_elective_course`
--
ALTER TABLE `U_PRGM_ELECTIVE_COURSE` ADD PRIMARY KEY (`COURSE_CODE`, `SESSION`), ADD KEY `FK_PRGM_ID2` (`PRGM_ID`) USING BTREE, ADD KEY `FK_COURSE_CODE2` (`COURSE_CODE`) USING BTREE, ADD KEY `FK_FACULTY_ID_ELECTIVE` (`FACULTY_ID`) USING BTREE;

--
-- Indexes for table `u_student`
--
ALTER TABLE `U_STUDENT` ADD PRIMARY KEY (`REGNO`), ADD UNIQUE KEY `EMAIL` (`EMAIL`), ADD KEY `FK_PRGM_ID3` (`PRGM_ID`);
...
--
ALTER TABLE `U_ADMINISTRATION` ADD CONSTRAINT `FK_FID` FOREIGN KEY (`F_ID`) REFERENCES `U_FACULTY` (`FACULTY_ID`);

--
-- Constraints for table `u_course`
--
ALTER TABLE `U_COURSE` ADD CONSTRAINT `U_COURSE_IBFK_1` FOREIGN KEY (`DEPT_ID`) REFERENCES `U_DEPT` (`DEPT_ID`);

--
-- Constraints for table `u_course_regn`
--
ALTER TABLE `U_COURSE_REGN` ADD CONSTRAINT `FK_COURSE_CODE3` FOREIGN KEY (`COURSE_CODE`) REFERENCES `U_COURSE` (`COURSE_CODE`), ADD CONSTRAINT `FK_FACULTY_ID` FOREIGN KEY (`FACULTY_ID`) REFERENCES `U_FACULTY` (`FACULTY_ID`), ADD CONSTRAINT `FK_REGNO` FOREIGN KEY (`REGNO`) REFERENCES `U_STUDENT` (`REGNO`);

--
-- Constraints for table `u_exam_regn`
--
ALTER TABLE `U_EXAM_REGN` ADD CONSTRAINT `FK_REGNO5` FOREIGN KEY (`REGNO`) REFERENCES `U_STUDENT` (`REGNO`);

--
-- Constraints for table `u_external_marks`
--
ALTER TABLE `U_EXTERNAL_MARKS` ADD CONSTRAINT `FK_COURSE_CODE1` FOREIGN KEY (`COURSE_CODE`) REFERENCES `U_COURSE` (`COURSE_CODE`), ADD CONSTRAINT `FK_REGNO1` FOREIGN KEY (`REGNO`) REFERENCES `U_STUDENT` (`REGNO`);

--
-- Constraints for table `u_faculty`
--
ALTER TABLE `U_FACULTY` ADD CONSTRAINT `FK_DEPT_ID2` FOREIGN KEY (`DEPT_ID`) REFERENCES `U_DEPT` (`DEPT_ID`);

--
-- Constraints for table `u_gpa_cgpa`
--
ALTER TABLE `U_GPA_CGPA` ADD CONSTRAINT `FK_REGNO2` FOREIGN KEY (`REGNO`) REFERENCES `U_STUDENT` (`REGNO`);

--
-- Constraints for table `u_hm_allotment`
--
ALTER TABLE `U_HM_ALLOTMENT` ADD CONSTRAINT `U_HM_ALLOTMENT_IBFK_1` FOREIGN KEY (`ALLOTED_PRGM`) REFERENCES `U_PRGM` (`PRGM_ID`), ADD CONSTRAINT `U_HM_ALLOTMENT_IBFK_2` FOREIGN KEY (`REGNO`) REFERENCES `U_STUDENT` (`REGNO`);

--
-- Constraints for table `u_hm_preregistration`
--
ALTER TABLE `U_HM_PREREGISTRATION` ADD CONSTRAINT `FK_PRGM_ID_HM1` FOREIGN KEY (`OPT1_PRGM_ID`) REFERENCES `U_PRGM` (`PRGM_ID`), ADD CONSTRAINT `FK_PRGM_ID_HM2` FOREIGN KEY (`OPT2_PRGM_ID`) REFERENCES `U_PRGM` (`PRGM_ID`), ADD CONSTRAINT `FK_PRGM_ID_HM3` FOREIGN KEY (`OPT3_PRGM_ID`) REFERENCES `U_PRGM` (`PRGM_ID`), ADD CONSTRAINT `FK_REGNO4` FOREIGN KEY (`REGNO`) REFERENCES `U_STUDENT` (`REGNO`);

--
-- Constraints for table `u_oec_allotment`
--
ALTER TABLE `U_OEC_ALLOTMENT` ADD CONSTRAINT `U_OEC_ALLOTMENT_IBFK_1` FOREIGN KEY (`REGNO`) REFERENCES `U_STUDENT` (`REGNO`), ADD CONSTRAINT `U_OEC_ALLOTMENT_IBFK_2` FOREIGN KEY (`COURSE_CODE`) REFERENCES `U_COURSE` (`COURSE_CODE`);
...
--
ALTER TABLE `U_PRGM_COMP_COURSE` ADD CONSTRAINT `FK_COURSE_CODE` FOREIGN KEY (`COURSE_CODE`) REFERENCES `U_COURSE` (`COURSE_CODE`), ADD CONSTRAINT `FK_PRGM_ID` FOREIGN KEY (`PRGM_ID`) REFERENCES `U_PRGM` (`PRGM_ID`);

--
-- Constraints for table `u_prgm_elective_course`
--
ALTER TABLE `U_PRGM_ELECTIVE_COURSE` ADD CONSTRAINT `FK_COURSE_CODE2` FOREIGN KEY (`COURSE_CODE`) REFERENCES `U_COURSE` (`COURSE_CODE`), ADD CONSTRAINT `FK_FACULTY_ID_ELECTIVE` FOREIGN KEY (`FACULTY_ID`) REFERENCES `U_FACULTY` (`FACULTY_ID`), ADD CONSTRAINT `FK_PRGM_ID2` FOREIGN KEY (`PRGM_ID`) REFERENCES `U_PRGM` (`PRGM_ID`);

--
-- Constraints for table `u_student`
--
ALTER TABLE `U_STUDENT` ADD CONSTRAINT `FK_PRGM_ID3` FOREIGN KEY (`PRGM_ID`) REFERENCES `U_PRGM` (`PRGM_ID`);
